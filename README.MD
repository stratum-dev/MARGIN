...
This is also the public and parallel version of prior work **AEGIS** (https://anonymous.4open.science/r/AEGIS-FECD/), which unifies the geometric perspective for embeddings distribution for imbalances.
